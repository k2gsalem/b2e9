    ...
    <main class="p-6 space-y-6">
        ...
        <div class="card compact">
            <div class="card-body space-y-6">
                ...
                <form wire:submit.prevent="updateBenefits" class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    @foreach($benefits as $index => $benefit)
                        <div wire:key="benefit-{{ $benefit->id }}" class="md:col-span-6">
                            <x-form.text-input type="text"
                                               wire:model.defer="benefits.{{ $index }}.title" name="benefits.{{ $index }}.title"
                                               label="" />
                        </div>
                    @endforeach
                    <div class="md:col-span-12 text-center py-4">
