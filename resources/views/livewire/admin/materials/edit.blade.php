        ...
        <div class="card compact">
            <div class="card-body space-y-6">
                ...
                <form wire:submit.prevent="update" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <x-form.text-input type="text" required class="md:col-span-2"
                                       wire:model.defer="model.title" name="model.title"
                                       label="Title"  />
                    <x-form.text-input type="number" required
                                       wire:model.defer="model.price" name="model.price"
                                       label="Current Price"  />
                    <x-form.text-input type="number" required
                                       wire:model.defer="model.density" name="model.density"
                                       label="Density"  />
